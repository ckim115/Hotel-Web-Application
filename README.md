...
2. Go to the file main.py
3. Install dependencies (DO EITHER):
    - virtual environment:
        - python3 -m venv venv
        - source venv/bin/activate
        - pip install -r requirements.txt
    - if you want to install dependencies onto your machine
        - pip install -r requirements.txt
4. Press the run button or type ‘python main.py’ in terminal
5. Follow the link to the web application, and choose to sign up if you do not have an account, or login if you do
6. To get a list of nearby hotels, click the ‘Get Hotels’ button. To see all saved hotels, click ‘View your saved hotels’ instead
7. Use the ‘Go back to main page’ button to return to the main page/
<br />    
Login Page:<br />                   
